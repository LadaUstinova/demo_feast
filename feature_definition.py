...
dataset_sal_view = FeatureView(
    ...
    features=[
        ...
        Feature(name="avg_sal_amt_all_2m", dtype=ValueType.FLOAT), #Среднее зп-начисление из всех источников за 2 мес
        Feature(name="avg_sal_amt_all_1m", dtype=ValueType.FLOAT), #Среднее зп-начисление из всех источников за 1 мес
